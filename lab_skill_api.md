...
1. MUST create a new project using Go 
2. Should write unit tests for the API using Go testing package
3. MUST use MySQL as the database
4. MUST use Docker compose to run database
5. MUST take DATABASE_URL as an environment variable
6. submit link to the repository
7. You can add any techniques or tools you think are necessary to make the project better
